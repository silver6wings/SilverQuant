...
class FeishuMessager(BaseMessager):
    ...
    @staticmethod
    def _get_markdown_card(title, text):
        card_style = {
            "schema": "2.0",
            "config": {
                "update_multi": True,
